/*
 * $Id: InterpolateStrokeFilter.java,v 1.2 2003/08/06 05:52:03 hwawen Exp $
 *
...
public class InterpolateStrokeFilter extends StrokeFilter {
    ...
    /** The spacing between two consecutive points. */
     ...
     * in the stroke has a distance greater than the pre-defined
     * spacing.
     */
